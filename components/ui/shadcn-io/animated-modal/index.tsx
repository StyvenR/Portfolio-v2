...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-4 group z-10 p-2 rounded-full hover:bg-red-600/20 transition-colors"
    >
      <svg
        ...
        className="text-red-600 h-5 w-5 group-hover:scale-125 group-hover:rotate-3 transition duration-200"
      >
